...
impl TestApi {
    pub async fn spawn() -> Self {
        ...
        // Change to project root so template paths work correctly
        ...
        // Don't override template paths - use defaults and change working directory
        // The ping test doesn't need templates anyway
